...
namespace ShippingSystem.Migrations
{
    ...
    [Migration("20251003140750_OrderStatusDescription")]
    partial class OrderStatusDescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShippingSystem.Models.OrderStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            Name = "DeliveredToRepresentitive"
                        },
                        new
                        {
                            Id = 4,
                        ...
                        {
                            Id = 9,
                            Name = "RejectedWithPaying"
                        },
                        new
                        {
                            Id = 10,
                            Name = "RejectedWithPartialPaying"
                        },
                        new
                        {
                            Id = 11,
                            Name = "RejectedFromEmployee"
                        });
                });

            modelBuilder.Entity("ShippingSystem.Models.OrderStatusRoleDescriptions", b =>
                {
                    b.Property<int>("StatusId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("StatusId", "RoleId");

                    b.HasIndex("RoleId");

                    b.ToTable("OrderStatusRoleDescriptions");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            StatusId = 3,
                            RoleId = "1",
                            Description = "تم التسليم للمندوب"
                        },
                        new
                        {
                            StatusId = 4,
                        ...
                        new
                        {
                            StatusId = 5,
                            RoleId = "1",
                            Description = "لا يمكن الوصول"
                        },
                        new
                        {
                            StatusId = 6,
                            RoleId = "1",
                            Description = "تم التاجيل"
                        },
                        new
                        {
                            StatusId = 7,
                            RoleId = "1",
                            Description = "تم التسليم جزئيا"
                        },
                        new
                        {
                            StatusId = 8,
                            RoleId = "1",
                            Description = "تم الالغاء من قبل المستلم"
                        },
                        new
                        {
                            StatusId = 9,
                            RoleId = "1",
                            Description = "تم الرفض مع الدفع"
                        },
                        new
                        {
                            StatusId = 10,
                            RoleId = "1",
                            Description = "رفض مع سداد جزء"
                        },
                        new
                        {
                            StatusId = 11,
                            RoleId = "1",
                            Description = "رفض من الموظف"
                        },
                        new
                        {
                            StatusId = 1,
            ...
            modelBuilder.Entity("ShippingSystem.Models.Roles", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ShippingSystem.Models.UserGroups", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("ShippingSystem.Models.Roles", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShippingSystem.Models.OrderStatusRoleDescriptions", b =>
                {
                    b.HasOne("ShippingSystem.Models.Roles", "Roles")
                        .WithMany("OrderStatusRoleDescriptions")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShippingSystem.Models.RefreshToken", b =>
                {
                    b.HasOne("ShippingSystem.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("ShippingSystem.Models.RefreshToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShippingSystem.Models.OrderStatus", b =>
                {
                    b.Navigation("OrderStatusRoleDescriptions");
                });
