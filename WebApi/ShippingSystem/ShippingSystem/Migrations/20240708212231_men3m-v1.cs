...
{
    /// <inheritdoc />
    public partial class men3mv1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //        CompanyOrderPrecentage = table.Column<float>(type: "real", nullable: true),
            //        SalePrecentage = table.Column<float>(type: "real", nullable: true),
            //        Branch_Id = table.Column<int>(type: "int", nullable: true)
            //    },
            //    constraints: table =>
            //    {
            ...
            //        InCompleteShippingRatio = table.Column<float>(type: "real", nullable: true),
            //        Branch_Id = table.Column<int>(type: "int", nullable: true),
            //        Governate_Id = table.Column<int>(type: "int", nullable: true),
